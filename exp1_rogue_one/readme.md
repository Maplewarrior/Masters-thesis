...
```bash
python exp1_rogue_one/experiment_run.py data.dataset="data/data_1.npz,data/data_2.npz,data/data_3.npz,data/data_4.npz,data/data_5.npz" unlearn.method="amnesiac,ssd,retrain,scrubr,sae,sisa" compress_pdfs=true hydra/launcher=ray --multirun
```
...
> [!NOTE]
> If you want PDF compressions, you should install ghostscript:
> ```bash
