...
| 64     | `random`   | `n_forget=50`                    | `python experiment_run.py unlearn.method=teacher_ascend unlearn.teacher_ascend._lambda=64 data.split_type="random" data.n_forget_points=100`                                                              | ✅          |
...
| Split Type | Split Details                     | Command                                                                                                                                                                          | Checkpoint |
| :--------- | :-------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------- |
...
| `random`   | `n_forget=50`                    | `python experiment_run.py unlearn.method=scrub data.split_type="random" data.n_forget_points=100`                                                                                  | ☐          |
