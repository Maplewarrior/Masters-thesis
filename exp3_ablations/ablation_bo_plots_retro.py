    ...
    for i in range(1,6):
        ...
        for smooth_dampen in [True, False]:
            ...
            savepath = create_structured_savepath(results_dir, 
                                                dataset_name, smooth_str, "decision_boundary", P=1, exploration_factor=2.5, n_bo_iter=100, smooth_dampening=smooth_dampen)
            ...
            title = f"$\\alpha$={hyperparams['max']['alpha_0']:.2f}, $\\lambda$={hyperparams['max']['_lambda_0']:.2f}\nTotal dampening: {total_dampening:.2f}"
            ...
            plt.savefig(create_structured_savepath(results_dir, dataset_name, smooth_str, "dampening", P=1, exploration_factor=2.5, n_bo_iter=100, smooth_dampening=smooth_dampen))
            plt.close()
